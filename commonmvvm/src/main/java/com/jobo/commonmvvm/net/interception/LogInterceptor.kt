package com.jobo.commonmvvm.net.interception

import android.util.Log
import com.jobo.commonmvvm.net.interception.logging.DefaultFormatPrinter
import com.jobo.commonmvvm.net.interception.logging.FormatPrinter
import com.jobo.commonmvvm.net.interception.logging.util.CharacterHandler.Companion.jsonFormat
import com.jobo.commonmvvm.net.interception.logging.util.UrlEncoderUtils.Companion.hasUrlEncoded
import com.jobo.commonmvvm.net.interception.logging.util.ZipHelper.Companion.decompressForGzip
import com.jobo.commonmvvm.net.interception.logging.util.ZipHelper.Companion.decompressToStringForZlib
import okhttp3.*
import okio.Buffer
