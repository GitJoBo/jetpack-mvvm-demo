 ...
 *
 */
class SystemFragment : BaseVbFragment<ThreeViewModel, IncludeSmartRefreshRvFloatingActionButtonBinding>() {
    ...
    override fun initView(savedInstanceState: Bundle?) {
        ...
        mSystemAdapter.run {
            setOnItemClickListener { adapter, view, position ->
                toStartActivity<SystemArrActivity>()
            }
    ...
    override fun onRequestSuccess() {
        mViewModel.tree.observe(viewLifecycleOwner, {
