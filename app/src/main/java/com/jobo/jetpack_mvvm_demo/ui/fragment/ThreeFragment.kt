...
import com.jobo.jetpack_mvvm_demo.databinding.FragmentThreeBinding
 ...
 *
 */
class ThreeFragment : BaseVbFragment<BaseViewModel, FragmentThreeBinding>() {
    val mTitleData = arrayListOf("广场", "每日一问", "体系", "导航")
    private var mFragments: ArrayList<Fragment> = arrayListOf()

    init {
        mFragments.add(PlazaFragment())
